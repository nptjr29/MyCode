...
public class PuzzleActivity extends AppCompatActivity {
    ...
    //in addition to the boilerplate, the given implementation programmatically adds the PuzzleBoardView object to the UI.
    @Override
    ...
    //trivial handlers for the other two buttons
